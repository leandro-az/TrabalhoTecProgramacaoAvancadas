...
public class FuncionariosModelComBotao extends AbstractTableModel 
{
    ...
    public FuncionariosModelComBotao(String identificador)
	{	
    	this.qtd = null;
	...
	public int getRowCount() {
		if(qtd == null)
			...
			qtd = funcionarioService.recuperaPeloNome(this.ident, 0, 50).size(); 
		...
		{	
			...
			{	
				...
				if(rowIndex >= rowIndexAnterior) 
				{
					...
					List<Funcionario> resultados = funcionarioService
						.recuperaPeloNome(ident, rowIndex - (NUMERO_DE_LINHAS_POR_PAGINA - 1), NUMERO_DE_LINHAS_POR_PAGINA * 2);
				...
				else
				{
					...
					List<Funcionario> resultados = funcionarioService
							.recuperaPeloNome(ident,  inicio, NUMERO_DE_LINHAS_POR_PAGINA * 2);
			...
			else
			{
				if(rowIndex >= rowIndexAnterior) 
				{
					...
					List<Funcionario> resultados = funcionarioService
							.recuperaPeloNome(ident, rowIndex, 
	...
	public void setValueAt(Object obj, int r, int c) 
	{
		...
		if(c == COLUNA_BOTAO) id = umFuncionario.getNumero();
